...
public class PrivateServerExecutor extends AbstractExecutor {
  ...
  public PrivateServerExecutor(
      Collection<Ticket, ?> collect, Mapper<? super TicketCollection, String> serial, Mapper<? extends TicketCollection, String> deserial, FileDescriptor fd, String path, Validator<Ticket> validator, Map<String, Command<?>> commands, Map<String, Query> cachedQueries) {
