...
public class ReadStringQueryStrategy implements QueryFillStrategy {
  private final AbstractShell shell;
  private final QueryFillStrategy prev;

  public ReadStringQueryStrategy(AbstractShell shell) {
    this(shell, null);
  }

  public ReadStringQueryStrategy(AbstractShell shell, QueryFillStrategy prev) {
    this.shell = shell;
    this.prev = prev;
  }
